	...
	return (
		<Container>
            ...
            feasibility of the plan, the plan will not be put on the shelves."
				...
				<Line2 />
				<RowContainer
					leftText="Relate page"
					rightText="The purpose of this page is to allow the project department to review
				...
				<Row>
					...
					<RightBlock>
						<CheckBoxLabel>
							...
							<Text1>&emsp;Agreement to Proposal</Text1>
						</CheckBoxLabel>
						<CheckBoxLabel>
							<CheckBox type="checkbox" />
							<Text1>
